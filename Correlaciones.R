...
#1.1 Para abrir la paqueteria utilizamos 

library("readxl")

#2.- Exportación de la matríz de datos
...
#3.- Exploración de la matríz

#3.1.- Dimensión de la matríz 

#Se utiliza el siguiente comando para saber la 
#dimensión de la matriz: **dim(BD)**
...
#Se utiliza la matríz marvel_dc.csv

#1.- Exportación de la matríz de datos
...
#Nota: elegimos columnas nuevas, debido a que la número 4 y la 6 son caracteres y necesitamos utilizar numéricas 
...
#8.- Realizar la correlacion de spearman con: 
...
#10.- Se utiliza la función kable en
#formato markdown 
#kable(spearman)
